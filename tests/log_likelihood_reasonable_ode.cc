...
int main()
{
  ...
  const std::vector<std::valarray<double>> data = {std::pow(all_data.tem_diam_time1/0.3000805, 3),
                                                   std::pow(all_data.tem_diam_time2/0.3000805, 3),
                                                   std::pow(all_data.tem_diam_time3/0.3000805, 3),
                                                   std::pow(all_data.tem_diam_time4/0.3000805, 3)};
  ...
  const Histograms::Parameters hist_prm(25, model.getSmallestParticleSize(ode_prm), model.getLargestParticleSize(ode_prm));
