...
int main() {
  ...
  const std::vector<std::string> folders = { "all_3step" };
  const std::string out_dir = "/home/danny/p/repos/mepbm/applications/ir-pom-paper/bin_vs_no_bin/";
  ...
  constexpr int samples_to_choose = 1000;
  ...
  for (const auto & folder : folders)
  {
    ...
    {
      std::string file_name = out_dir + "/random_solutions_time" + std::to_string(t + 1) + ".m";
      files[t] = file_name;
