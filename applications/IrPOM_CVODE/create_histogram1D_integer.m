...
%
%
function create_histogram1D_integer(x_vals, labels, bin_width, font_size, limits, ticks, tick_labels)
    ...
    % different models.
    histogram(x_vals, 'BinWidth', bin_width, 'Normalization','pdf','EdgeAlpha',0);
