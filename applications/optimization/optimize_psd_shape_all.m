...
% name the log file
scenario = 'optimize_psd_shape_all_v3';
...
kf_mult = optimizableVariable('kf_mult',[0.1, 10],'Transform','log','Optimize',true);
k1_mult = optimizableVariable('k1_mult',[0.1, 10],'Transform','log','Optimize',true);
...
stopFcn = @(results,state) stopBayesianOptimization(results,state,500,0.001);
%% Perform BO
