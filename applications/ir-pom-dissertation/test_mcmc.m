%% Don't use right now. The adaptive phase doesn't work well enough
clc
clearvars
close all
...
%% Run 2 -- Adaptation phase of adaptive Metropolis-Hastings
rng(seed,'twister')

fprintf(logID,"================================\n");
fprintf(logID,"Run 2 - aMH - Adaptation phase\n");
fprintf(logID,"================================\n");
...
%% Run 3 -- Stationary phase of adaptive Metropolis-Hastings
rng(seed,'twister')

fprintf(logID,"================================\n");
fprintf(logID,"Run 3 - aMH - Stationary phase\n");
fprintf(logID,"================================\n");
...
% Covariance matrix from adaptive phase
sigma = BI.Results.PostProc.Dependence.Cov;
